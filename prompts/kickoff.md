...
Team dir: {{TEAM_DIR}}          Jama project: {{JAMA_PROJECT}}
...
3.  Regenerate TRACEABILITY.md; summarize what changed.        [SIGN-OFF]
4.  Run the checks in CI.yml locally and confirm they pass.
5.  Prepare the Jama import: {{jama-import-workbook | jama-mcp payload}}.
...
# 13. Branch the DAG repo, add {{TEAM_DIR}}, expand DAG scope.
```
